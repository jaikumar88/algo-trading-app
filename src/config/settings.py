...
class Settings(BaseSettings):
    ...
    # Database
    DATABASE_URL: str = Field(default="sqlite:///dev_trading.db", env="DATABASE_URL")
    ...
    GOOGLE_API_KEY: Optional[str] = Field(default=None, env="GOOGLE_API_KEY")  # Alias for Gemini
    
    # Exchange API (for trading platforms like Binance, etc.)
    ...
    # Database connection components (alternative to DATABASE_URL)
